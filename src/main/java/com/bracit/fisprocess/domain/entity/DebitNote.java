...
/**
 * An AP Debit Note — reverses all or part of a bill's outstanding balance.
 */
@Entity
@Table(name = "fis_debit_note")
@Getter
@Setter
...
public class DebitNote {
    ...
    @Column(name = "debit_note_id", updatable = false, nullable = false)
